...
void course_save()
{
    ofstream out("C://Users//11794//Desktop//学生成绩管理系统//学生成绩管理系统（3//学生成绩管理系统//学生成绩管理系统//course_information.txt");//打开文件
	Course c2;
	out << c2;
	out.close();
}
...
int coursemain()
{
	ifstream in("C://Users//11794//Desktop//学生成绩管理系统//学生成绩管理系统（3//学生成绩管理系统//学生成绩管理系统//course_information.txt");//打开文件
     //   C:\Users\11794\Desktop\学生成绩管理系统\学生成绩管理系统（3\学生成绩管理系统\学生成绩管理系统
	Course c1;
	in >> c1;
    initial_courselist();
    in.close();
